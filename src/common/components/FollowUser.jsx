...
export const FollowUsers = () => {
    ...
    return (
        <div
            className="flex px-4 border mt-4 border-gray-600 rounded-md p-2 w-1/4 flex-col h-auto">
            <div
                                    ...
                                    <div
                                        ...
                                        <ul className="mb-4 mr-8">
                                            <div className="ml-4 flex-col pb-4">
                                                <li className="font-semibold ml-12">{userProfile
                                                        ?.name}</li>
                                                <li className="text-gray-400 -mt-1 ml-12">@{userProfile
                                                        ?.username}</li>
                                            </div>
                                            <li><img
                                                src={userProfile
                                        ?.profileURL}
                                                alt="profile url"
                                                className="rounded-full w-10 h-10 -mt-14 cursor-pointer overflow-hidden"/></li>
                                        </ul>
                                    </div>
                                );
                            })}
